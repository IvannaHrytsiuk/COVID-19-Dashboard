...
export class CountriesTableModel {
    ...
    tableConnect(val) {
        if (sessionStorage.getItem('country')) {
            ...
            if (val === 'Total confirmed' || val === 'Total death' || val === 'Total recovered' || val === 'Total confirmed 100K' || val === 'Total death 100K' || val === 'Total recovered 100K') {
                tableModel.getMoodTable('Total');
                document.getElementById('selectMoodShow').value = 'Total';
            } else if (val === 'New confirmed' || val === 'New death' || val === 'New recovered' || val === 'New confirmed 100K' || val === 'New death 100K' || val === 'New recovered 100K') {
                tableModel.getMoodTable('New');
                document.getElementById('selectMoodShow').value = 'New';
            }
        }
