...
// eslint-disable-next-line class-methods-use-this
    paintTable(value) {
        ...
        case 'Total death':
            for (let i = 0; i < covidData.Countries.length; i += 1) {
                document.querySelector('.countryTbody').innerHTML += `<tr><td>${covidData.Countries[i].Country}</td><td>${covidData.Countries[i].TotalDeaths}</td></tr>`;
            }
            break;
        case 'Total recovered':
            for (let i = 0; i < covidData.Countries.length; i += 1) {
                document.querySelector('.countryTbody').innerHTML += `<tr><td>${covidData.Countries[i].Country}</td><td>${covidData.Countries[i].TotalRecovered}</td></tr>`;
            }
            break;
        case 'New confirmed':
            for (let i = 0; i < covidData.Countries.length; i += 1) {
                document.querySelector('.countryTbody').innerHTML += `<tr><td>${covidData.Countries[i].Country}</td><td>${covidData.Countries[i].NewConfirmed}</td></tr>`;
            }
            break;
        case 'New death':
            for (let i = 0; i < covidData.Countries.length; i += 1) {
                document.querySelector('.countryTbody').innerHTML += `<tr><td>${covidData.Countries[i].Country}</td><td>${covidData.Countries[i].NewDeaths}</td></tr>`;
            }
            break;
        case 'New recovered':
            for (let i = 0; i < covidData.Countries.length; i += 1) {
                document.querySelector('.countryTbody').innerHTML += `<tr><td>${covidData.Countries[i].Country}</td><td>${covidData.Countries[i].NewRecovered}</td></tr>`;
            }
            break;
        case 'Total confirmed 100K':
            for (let i = 0; i < covidData.Countries.length; i += 1) {
                ...
                document.querySelector('.countryTbody').innerHTML += `<tr><td>${covidData.Countries[i].Country}</td><td>${popul100.toFixed(2)}</td></tr>`;
            }
            break;
